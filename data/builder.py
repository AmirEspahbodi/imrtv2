...
def generate_dataset_from_folder(cfg, train_transform, test_transform):
    ...
    if cfg.dataset.preload_path:
        ...
        train_dataset = AsymetricImageFolder(
            train_path, train_lpm_transform, train_side_transform
        )
        test_dataset = AsymetricImageFolder(
            test_path, test_lpm_transform, test_side_transform
        )
        val_dataset = AsymetricImageFolder(
            val_path, test_lpm_transform, test_side_transform
        )
